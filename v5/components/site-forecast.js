const locations = {
  'kbc': {
    ...
    url_photo: window.getLocationImage('kbc'),
  ...
  'bos': {
    ...
    url_photo: window.getLocationImage('bos'),
  ...
  'yas': {
    ...
    url_photo: window.getLocationImage('yas'),
  ...
  'dosc': {
    ...
    url_photo: window.getLocationImage('dosc'),
  ...
  'sandy': {
    ...
    url_photo: window.getLocationImage('sandy'),
  ...
  'mikoko': {
    ...
    url_photo: window.getLocationImage('mikoko'),
    windScriptId: 'wglive_3568_1668852175054',
    windArgs: ["spot=3568", "uid=wglive_3568_1668852175054", "direct=1", "wj=knots", "tj=c", "avg_min=0", "gsize=250", "msize=300", "m=3", "show=n,g,c"],
    forecastScriptId: 'wg_fwdg_1136989_3_1668852348455',
