class SiteNav extends HTMLElement {
      ...
      this.innerHTML = `
        <div class="nav-container">
          <div class="nav-card-wrapper" data-page="kbc" draggable="true">
            <div class="nav-card" style="background-image: url('${window.getLocationImage('kbc')}')">
    ...
    injectWindguruWidgets() {
      ...
      window.injectWindguruWidget('2146', 'wglive_2146_nav_1706848056699', 0, widgetElements);
      window.injectWindguruWidget('3568', 'wglive_3568_nav_1706847920748', 1, widgetElements);
      window.injectWindguruWidget('3858', 'wglive_3858_nav_1710779222995', 2, widgetElements);
      window.injectWindguruWidget('4065', 'wglive_4065_nav_1715855101032', 3, widgetElements);
      window.injectWindguruWidget('2014', 'wglive_2014_nav_1713422960240', 4, widgetElements);
    }
