class SiteNav extends HTMLElement {
  constructor() {
    super();
    const locations = [
      { page: 'kbc', text: 'Kitesurf Beach Center, UAQ', image: window.getLocationImage('kbc') },
      { page: 'bos', text: 'Blue Ocean Sports, JA', image: window.getLocationImage('bos') },
      { page: 'yas', text: 'Yas Kite Area, Abu Dhabi', image: window.getLocationImage('yas') },
      { page: 'dosc', text: 'Dubai Offshore Sailing Club', image: window.getLocationImage('dosc') },
    ...
    this.innerHTML = `
      <div class="nav-container">
        ${locations.map(loc => `
          <div class="nav-card-wrapper" data-page="${loc.page}" draggable="true">
